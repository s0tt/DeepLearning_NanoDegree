...
echo "After that step, you can run the project assistant. To do that, first go to the first-neural-network directory ('cd first-neural-network') and then submit your project with : 